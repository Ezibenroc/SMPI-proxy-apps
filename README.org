...
The following graph shows the amount of passed and failed tests when
running these proxy apps with smpi.

#+BEGIN_EXPORT html
<img src="https://ci.inria.fr/simgrid/job/SMPI-proxy-apps/test/trend?failureOnly=false"/>
#+END_EXPORT
