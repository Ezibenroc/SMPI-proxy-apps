...
[[https://ci.inria.fr/simgrid/job/SMPI-proxy-apps-multi/build_mode=SMPI,label=proxy-apps/test/?width=800&height=600][dedicated jenkins server]].
...
#+BEGIN_EXPORT html
<ul>
  <li><a href="http://bigdft.org>BigDFT</a> is a DFT massively parallel
   electronic structure code using a wavelet basis set.
   <a href='https://ci.inria.fr/simgrid/job/SimGrid-BigDFT/'><img src='https://ci.inria.fr/simgrid/job/SimGrid-BigDFT/badge/icon'></a>
  </li>
</ul>
#+END_EXPORT
 - [[http://starpu.gforge.inria.fr/][StarPU]] is an unified runtime
   system for heterogeneous multicore architectures.
   [[https://ci.inria.fr/simgrid/job/SimGrid-StarPU/][SMPI-based nightly testing]]

* [[https://proxyapps.exascaleproject.org/app/][ECP]] Proxy Applications 
| Benchmark  | Lines | paral | Lang | SMPI | Patch |
|------------+-------+-------+------+------|-------|
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#amg][AMG]] | 4,658 | MPI, OMP | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/AMG/patch_AMG.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#clamr][CLAMR]] | 109,477 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/CLAMR/patch_clamr][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#comd][CoMD]] | 4,658 | MPI, OMP | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/CoMD/patch_CoMD.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#cosp2][CoSP2]] | 2,199 | MPI | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/CoSP2/patch_CoSP2.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#cloverleaf][CloverLeaf]] | 37,477  | MPI, OMP | C,F90 | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/Mantevo.org#cloverleaf][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#ebmc][EBMC rget]] | 841 | MPI | C++, F90 | :sunny: | :black_small_square: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#examinimd][ExaMiniMD]] | 6,184 | MPI, OMP | C++ | :sunny: | :black_small_square: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#hpccg][HPCCG]] | 1,548 | MPI, OMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/HPCCG/patch_HPCCG.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#kriple][Kripke]] | 109,477 | MPI, OpenMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/kripke/patch_kripke.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#minitri][MINITRI (linearAlgebra)]] | 1,534 | MPI, OMP | C++ | :sunny: | :black_small_square: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#miniaero][MiniAero]] | 4,645 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/miniAero/patch_makefile.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#miniamr][MiniAMR]] | 8,329 | MPI | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/MiniAMR/patch_MiniAMR.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#minief][MiniFE-evo]] | 19,907 | MPI | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/MiniEF-evo/patch_MiniFE.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#minismac2d][MiniSMAC2D]] | 8,329  | MPI, OMP | F90 | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/tree/master/src/ECP/MiniSMAC2D][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#minixyce][MiniXyce]] | 2,020 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/MiniXyce/patch_MiniXyce.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#pennant][PENNANT]] | 3,464 | MPI, OMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/tree/master/src/ECP/PENNANT][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#quicksilver][Quicksilver]] | 9,821 | MPI, OMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/tree/master/src/ECP/Quicksilver][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#simplemoc][SimpleMOC]] | 2,864 | MPI, OMP | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/SimpleMOC/patch_SimpleMOC.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#swfft][SWFFT]] | 3,827 | MPI, OMP | C++,C,F90 | :sunny: | :black_small_square: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#sw4lite][Sw4lite]] | 48,436 | MPI, OMP | C | :sunny: | :black_small_square: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#tealeaf][TeaLeaf]] | 5,729 | MPI, OMP | F90 | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/TeaLeaf/patch_tealeaf.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#vpfft][VPFFT]] | 3,384 | MPI, OMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/VPFFT/patch_vpfft.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#snbone][SNBONE]] | 5,897 | MPI | F90 | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/tree/master/src/ECP/SNbone][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#minimd][MiniMD]] | 9,344 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/ECP/MiniMD/patch_miniMD_Makefile.diff][:ticket:]] |

*** Disabled Apps
MPI not used: PathFinder, CoHMM, NuT, LCALS, RSBench, CoGL, ASPA.

Using OpenMP: XSBench, Tycho2, MiniGMG, SNAP, Nekbone, Clover3D.
...
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/Trinity-Nersc.org#gtc][GTC]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/gtc/][:book:]][[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/May31/TrN8GTCMay30.tar][:package:]] | 5,591 | MPI, OMP | F90 | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/Trinity-Nersc/GTC/patch_gtc.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/Trinity-Nersc.org#milc][MILC]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/milc/][:book:]][[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/May31/TrN8MILC7May30.tar][:package:]] | 82,645 | MPI, OMP | C | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/Trinity-Nersc/MILC/patch_MILC.diff][:ticket:]]
...
| Benchmark  |  Lines | paral | Lang | SMPI | Patch |
|------------+--------+-------+------+------|-------|
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/CodeVault.org#parallel_io][Parallel_io]] | 1,338 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/CodeVault/parallel_io/patch_basicMPIIO.diff][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/CodeVault.org#mcm][MCM]] | 453 | MPI, OMP | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/tree/master/src/CodeVault/monte_carlo_methods][:ticket:]] |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/CodeVault.org#dyn-sparse][n-Body_methods (dyn sparse)]] | 2,401 | MPI | C++ | :sunny: | [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/src/CodeVault/n-body_methods/patch_dynSparse.diff][:ticket:]] |
...
|---------+---------+--------+---------|
| :sunny: | Execution is done successfully | :wrench: | Need some adjustments |
