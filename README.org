...
| Benchmark  | Ref | Lines of code | paral | Lang | Build with MPI | Run with MPI | Build with SMPI | Run with SMPI |
|------------+-----+---------------+-------+------+----------------+--------------+-----------------+-----------------|
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#comd][CoMD]] | NONE | unknown | MPI, OpenMP | C | :white_check_mark: | :white_check_mark: | :white_check_mark: | :x: |
| [[https://github.com/simgrid/SMPI-proxy-apps/blob/master/ECP.org#amg][AMG]] | NONE | unknown | MPI, OpenMP | C | :white_check_mark: | :white_check_mark: | :x: | / |
