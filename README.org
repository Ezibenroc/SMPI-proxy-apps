...
MPI not used: Graph500, SPECint2006"peak", Memory benchmarks, CLOMP, LCALS, FTQ, XSBench, NEKbonemk, HACCmk, UMTmk, AMGmk, MILCmk, GFMCmk.
...
Code source not available: CoMD.
...
*** Disabled Apps
MPI not used: PathFinder, CoHMM, NuT. 
...
| CANDLE | Python language |

Code source not available: Ember, AMR_Exp_Parabolic.
