...
#+BEGIN_SRC sh :tangle bin/ECP_PENNANT.sh
     ...
     echo "Install the modified sources"
     cp ../../src/common/* ./PENNANT/test/
     cp ../../src/ECP/PENNANT/* ./PENNANT/
     cd PENNANT/
     ...
     echo "Run it"
     smpirun -np 8 -hostfile ./cluster_hostfile.txt -platform ./cluster_crossbar.xml --cfg=smpi/host-speed:100 ../build/pennant ./leblanc/leblanc.pnt
